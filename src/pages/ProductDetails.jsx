...
const ProductDetails = () => {
  ...
  const submitHandle = (e) => {
    ...
    toast.success('Su opinión ha sido guardada con éxito')
  ...
  const addToCart = () => {
    ...
    toast.success('El producto ha sido añadido con éxito!')
  }
          ...
          <Col lg='6'>
            <div className='product__details'>
              ...
              <div className='product__rating d-flex align-items-center gap-5 mb-4 '>
                ...
                <p>(<span>{avgRating}</span> de valoración)</p>
              </div>
        ...
        <Row>
          <Col lg='12'>
            <div className='tab__wrapper d-flex align-items-center gap-5'>
              ...
              <h6 className={`${tab === "rev" ? "active__tab" : ""}`} onClick={() => setTab('rev')}>Opiniones ({reviews.length})</h6>
            </div>

            {
              tab === 'desc' ? (<div className='tab__content mt-5'><p>{description}</p></div>) : (<div className='product__review mt-5'>
                  ...
                  <div className='review__form'>
                    <form action='' onSubmit={submitHandle}>
                      ...
                      <div className='form__group'>
                        <input type='text' placeholder='Escribe tu nombre' ref={reviewUser} required/>
                      </div>
                      ...
                      <div className='form__group'>
                        <textarea ref={reviewMsg} rows={4} type='text' placeholder='Escribe tu opinión' required/>
                      </div>
